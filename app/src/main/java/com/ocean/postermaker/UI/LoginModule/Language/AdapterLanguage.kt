...
import com.ocean.postermaker.databinding.AdapterLanguageBinding

class AdapterLanguage(var context: Activity, list: java.util.ArrayList<LanguageModel.Data>, OnClicked: BtnClickListener) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    var list: ArrayList<LanguageModel.Data>
    var inflater: LayoutInflater
    var OnClicked: BtnClickListener
    var selectedPosition: Int = -1
    lateinit var binding: AdapterLanguageBinding
    ...
    class DataHolder(view: View, binding: AdapterLanguageBinding) :
        RecyclerView.ViewHolder(view) {
        var binding: AdapterLanguageBinding
    ...
    open interface BtnClickListener {
        fun onClick(list: LanguageModel.Data, position: Int, mViewHolder: DataHolder)
    }
}