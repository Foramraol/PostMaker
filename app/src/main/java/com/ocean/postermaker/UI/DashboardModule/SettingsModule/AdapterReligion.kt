...
class AdapterReligion(var context: Activity, list: java.util.ArrayList<getReligionsModel.Data>, OnClicked: BtnClickListener) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    var list: ArrayList<getReligionsModel.Data>
    ...
    override fun onBindViewHolder(
        ...
        mViewHolder.itemView.setOnClickListener(object : View.OnClickListener {
            override fun onClick(p0: View?) {
                OnClicked.onClick(list[position].name, position, mViewHolder)
            }
        })
    }
