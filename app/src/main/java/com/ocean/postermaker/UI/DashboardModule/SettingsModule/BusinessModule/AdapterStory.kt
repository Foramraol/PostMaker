...
class AdapterStory(var context: Activity, list: ArrayList<String>, OnClicked: BtnClickListener) :
    ...
    override fun onBindViewHolder(
        ...
        mViewHolder.binding.ivPost.minimumHeight = 210
        mViewHolder.binding.ivPost.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.iv_demo_story))
