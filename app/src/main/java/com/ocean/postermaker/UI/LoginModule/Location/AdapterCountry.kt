...
class AdapterCountry(var context: Activity, list: java.util.ArrayList<CountryModel.Data>, OnClicked: BtnClickListener) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    var list: ArrayList<CountryModel.Data>
    ...
    open interface BtnClickListener {
        fun onClick(list: CountryModel.Data, position: Int, mViewHolder: DataHolder)
    }
}