...
class AdapterCity(var context: Activity, list: java.util.ArrayList<CityModel.Data>, OnClicked: BtnClickListener) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    var list: ArrayList<CityModel.Data>
    ...
    open interface BtnClickListener {
        fun onClick(list: CityModel.Data, position: Int, mViewHolder: DataHolder)
    }
}